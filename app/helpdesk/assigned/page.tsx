...
export default async function Page() {
  ...
  const issueResponse = await axios.get(process.env.NEXT_PUBLIC_BASE_URL + '/api/issue/read/assigned?userid=' + user.id);
  ...
  return (
    <section className='space-y-4'>
      <h1 className='text-3xl font-medium tracking-tighter'>Issues assigned to you</h1>
